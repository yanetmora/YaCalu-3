...
public class SentencesInFrontActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnVerify = (Button) findViewById(R.id.btn_check);
        btnVerify.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                EditText squareText = (EditText) findViewById(R.id.edit_complete);

                if (squareText.getText().toString().toLowerCase().equals("in front of")) {
                    TEXT.setText(R.string.respco);
